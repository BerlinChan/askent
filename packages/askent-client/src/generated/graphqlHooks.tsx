...
export type QuestionAudienceFieldsFragment = (
  { __typename?: 'Question' }
  & Pick<Question, 'id' | 'createdAt' | 'updatedAt' | 'content' | 'reviewStatus' | 'top' | 'star' | 'voted' | 'voteUpCount' | 'replyCount'>
  & { author?: Maybe<(
    { __typename?: 'User' }
    & Pick<User, 'id' | 'name' | 'avatar'>
  )> }
...
export const EventsByMeDocument = gql`
    query EventsByMe($searchString: String, $pagination: PaginationInput!, $dateStatusFilter: EventDateStatus) {
  eventsByMe(
